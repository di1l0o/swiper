**Malicious Dependency Risk in "swiper" Project**  

The "swiper" project depends on the following two packages:  

- "semantic-types"  
- "solana-publickey"  

![image-20250618160657735](https://github.com/user-attachments/assets/bb242189-be74-4907-a0d4-9e66d1a0d04e)

"semantic-types" is the core malicious package containing a key-stealing payload, while "solana-publickey" serves as a camouflage package. It depends on the core package and automatically installs the malicious payload through transitive dependency mechanisms. Below is an introduction to the malicious behaviors of the "semantic-types" package.  
